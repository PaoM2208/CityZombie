...
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 200, 300, 30, 30, 2),
    new Obstaculo('imagenes/valla_vertical.png', 100, 400, 30, 30, 2),
    new Obstaculo('imagenes/auto_verde_abajo.png', 280, 410, 15, 30, 2),
    new Obstaculo('imagenes/bache.png', 310, 460, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 410, 240, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 510, 300, 30, 30, 2),
    new Obstaculo('imagenes/bache.png', 610, 190, 30, 30, 2),
  ],
  ...
  enemigos: [
    new ZombieCaminante('imagenes/zombie1.png', 100, 210, 10, 10, 1, {
      desdeX: 75, hastaX: 190, desdeY: 380, hastaY: 380
    }, "horizontal"),
    new ZombieCaminante('imagenes/zombie2.png', 300, 100, 10, 10, 1, {
      desdeX: 0, hastaX: 900, desdeY: 400, hastaY: 430
    }, "horizontal"),
    new ZombieCaminante('imagenes/zombie4.png', 600, 700, 10, 10, 1, {
      desdeX: 0, hastaX: 800, desdeY: 400, hastaY: 450
    }, "vertical"),
    new ZombieConductor('imagenes/tren_vertical.png', 644, 100, 30, 90, 1, {
      desdeX: 100, hastaX: 100, desdeY: 70, hastaY: 30
    }, "vertical"),
    new ZombieConductor('imagenes/tren_horizontal.png', 100, 322, 90, 30, 1, {
      desdeX: 30, hastaX: 850, desdeY: 322, hastaY: 322
    }, "horizontal"),
    new ZombieCaminante('imagenes/zombie3.png', 670, 740, 10, 10, 1, {
      desdeX: 760, hastaX: 870, desdeY: 470, hastaY: 470
    }, "horizontal")
  ]
}
...
Juego.dibujar = function () {
  ...
  Dibujante.dibujarRectangulo('white', 758, 500, 130, 20);
};
